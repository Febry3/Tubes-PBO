...
public class MainUser extends javax.swing.JFrame {
     ...
     */
    private BuatReservasi reserv;
    private ArsipKunjungan arsip;
    public MainUser() {
        initComponents();
        reserv = new BuatReservasi();
        arsip = new ArsipKunjungan();
        menuUser.addEventMenuUser(new EventMenuUser() {
            @Override
            public void selectedMenuUser(int index) {
                if (index == 1) {
                    setForm(reserv);
                } else if (index == 2) {
                    setForm(arsip);
    ...
    private void initComponents() {
        ...
        panelBorder1Layout.setHorizontalGroup(
            ...
            .addGroup(panelBorder1Layout.createSequentialGroup()
                ...
                .addComponent(mainPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 975, Short.MAX_VALUE))
        );
